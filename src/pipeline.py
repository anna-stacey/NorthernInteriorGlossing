...
def main(seg_output_file, gloss_train_file, gloss_dev_file, gloss_test_file, segmentation_line_number, gloss_line_number):
    ...
    # Put the seg lines back together
    seg_output = reassemble_predicted_line(read_file(gloss_test_file), seg_output)
