...
python3 src/eval_gloss.py --test_file=$GLOSS_TEST_SET --output_file=$OUTPUT_FOLDER$OUTPUT_FILE --segmentation_line_number=$SEG_LINE_NUMBER --gloss_line_number=$GLOSS_LINE_NUMBER
