...
WHOLE_INPUT_1=./test_data/test_1.txt
INPUT_1=./test_data/test_1.input
TRAIN_INPUT_1=./test_data/test_1.input
OUTPUT_1=./test_data/test_fairseq_1.output
GOLD_OUTPUT_1=./test_data/test_1.output
...
WHOLE_INPUT_2=./test_data/test_1.txt
INPUT_2=./test_data/test_1.input
TRAIN_INPUT_2=./test_data/test_2_train.input
OUTPUT_2=./test_data/test_fairseq_2.output
GOLD_OUTPUT_2=./test_data/test_2.output
EXPECTED_RESULTS_2="0.00%,None,None,None,None,None,None,None,100.00%,0.00%"

# Gold boundaries, no predicted boundaries, 0% correct
WHOLE_INPUT_3=./test_data/test_3.txt
INPUT_3=./test_data/test_1.input
OUTPUT_3=./test_data/test_fairseq_3.output
GOLD_OUTPUT_3=./test_data/test_3.output
EXPECTED_RESULTS_3="0.00%,None,0.00%,0.00%,None,0.00%,0.00%,0.00%,None,None"

# Gold boundaries, predicted boundaries, 100% correct
WHOLE_INPUT_4=./test_data/test_3.txt
INPUT_4=./test_data/test_1.input
OUTPUT_4=./test_data/test_fairseq_4.output
GOLD_OUTPUT_4=./test_data/test_3.output
...
WHOLE_INPUT_5=./test_data/test_3.txt
INPUT_5=./test_data/test_1.input
OUTPUT_5=./test_data/test_fairseq_5.output
GOLD_OUTPUT_5=./test_data/test_3.output
...
WHOLE_INPUT_6=./test_data/test_3.txt
INPUT_6=./test_data/test_1.input
OUTPUT_6=./test_data/test_fairseq_6.output
GOLD_OUTPUT_6=./test_data/test_3.output
...
WHOLE_INPUT_TIGER=./test_data/test_21.txt
INPUT_TIGER=./test_data/test_1.input
TRAIN_INPUT_TIGER=./test_data/test_21_train.input
OUTPUT_TIGER=./test_data/test_fairseq_21.output
GOLD_OUTPUT_TIGER=./test_data/test_21.output
...
GOLD_7=./test_data/test_1.txt
OUTPUT_7=./test_data/test_7_pred.txt
...
GOLD_8=./test_data/test_1.txt
OUTPUT_8=./test_data/test_9_pred.txt
STEM_DICT_8="{}"
EXPECTED_RESULTS_8="0.00%,0.00%,0.00%,None,None,0.00%,None"

# All grams, all correct
GOLD_9=./test_data/test_1.txt
OUTPUT_9=./test_data/test_1.txt
...
GOLD_10=./test_data/test_10.txt
OUTPUT_10=./test_data/test_9_pred.txt
...
GOLD_11=./test_data/test_10.txt
OUTPUT_11=./test_data/test_7_pred.txt
STEM_DICT_11="{\"jkasdn\": \"something\", \"kasdn\": \"something\"}"
EXPECTED_RESULTS_11="0.00%,0.00%,None,0.00%,0.00%,None,0.00%"

# All stems, all correct
GOLD_12=./test_data/test_10.txt
OUTPUT_12=./test_data/test_10.txt
...
GOLD_13=./test_data/test_10.txt
OUTPUT_13=./test_data/test_13_pred.txt
...
GOLD_14=./test_data/test_10.txt
OUTPUT_14=./test_data/test_14_pred.txt
STEM_DICT_14="{}"
EXPECTED_RESULTS_14="50.00%,50.00%,66.67%,0.00%,50.00%,None,None"

# Moving into multi-morphemic words
# Mixed stems/grams, all correct
GOLD_15=./test_data/test_3.txt
OUTPUT_15=./test_data/test_3.txt
...
GOLD_16=./test_data/test_3.txt
OUTPUT_16=./test_data/test_16_pred.txt
...
GOLD_17=./test_data/test_3.txt
INPUT_17=./test_data/test_1.input
TRAIN_INPUT_17=./test_data/test_1.input
OUTPUT_17=./test_data/test_17_pred.txt
EXPECTED_RESULTS_17="100.00%,100.00%,50.00%,0.00%,None"

# Mixed stems/grams, glosses correct but seg mistakes, (incl. boundary-only mistakes), no OOV words
# 6/8 morphemes correct (7/8 BoW), 2/4 stems correct, 4/5 grams correct
GOLD_18=./test_data/test_3.txt
INPUT_18=./test_data/test_1.input
TRAIN_INPUT_18=./test_data/test_1.input
OUTPUT_18=./test_data/test_18_pred.txt
...
GOLD_19=./test_data/test_11.txt
INPUT_19=./test_data/test_1.input
TRAIN_INPUT_19=./test_data/test_2_train.input
OUTPUT_19=./test_data/test_19_pred.txt
...
GOLD_20=./test_data/test_20.txt
OUTPUT_20=./test_data/test_20_pred.txt
INPUT_20=./test_data/test_1.input
TRAIN_INPUT_20=./test_data/test_21_train.input
...
python3 test_eval.py --results_csv=$GLOSS_RESULTS_CSV --expected_results=$EXPECTED_RESULTS_7
...
python3 test_eval.py --results_csv=$GLOSS_RESULTS_CSV --expected_results=$EXPECTED_RESULTS_8
...
python3 test_eval.py --results_csv=$GLOSS_RESULTS_CSV --expected_results=$EXPECTED_RESULTS_9
...
python3 test_eval.py --results_csv=$GLOSS_RESULTS_CSV --expected_results=$EXPECTED_RESULTS_10
...
python3 test_eval.py --results_csv=$GLOSS_RESULTS_CSV --expected_results=$EXPECTED_RESULTS_11
...
python3 test_eval.py --results_csv=$GLOSS_RESULTS_CSV --expected_results=$EXPECTED_RESULTS_12
...
python3 test_eval.py --results_csv=$GLOSS_RESULTS_CSV --expected_results=$EXPECTED_RESULTS_13
...
python3 test_eval.py --results_csv=$GLOSS_RESULTS_CSV --expected_results=$EXPECTED_RESULTS_14
...
python3 test_eval.py --results_csv=$GLOSS_RESULTS_CSV --expected_results=$EXPECTED_RESULTS_15
...
python3 test_eval.py --results_csv=$GLOSS_RESULTS_CSV --expected_results=$EXPECTED_RESULTS_16
...
python3 test_eval.py --results_csv=$PIPELINE_RESULTS_CSV --expected_results=$EXPECTED_RESULTS_17
...
python3 test_eval.py --results_csv=$PIPELINE_RESULTS_CSV --expected_results=$EXPECTED_RESULTS_18
...
python3 test_eval.py --results_csv=$PIPELINE_RESULTS_CSV --expected_results=$EXPECTED_RESULTS_19
